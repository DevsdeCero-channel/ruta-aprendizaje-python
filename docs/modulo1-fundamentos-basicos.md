...
* [**Las Variables**](#las-variables)
    * [Caracteres válidos](#caracteres-validos)
...
* [**Estructuras de control**](#estructuras-de-control)
    ...
    * [Bucles](#bucles)
        ...
        * [Bucle _for_](#bucle-for)
            * [El uso del bucle for con la función range()](#el-uso-del-bucle-for-con-la-funcion-range)
        * [Controlando el flujo del bucle](#controlando-el-flujo-del-bucle)
* [**Las funciones**](#las-funciones)
    * [Cómo definir una función](#definir-una-funcion)
    * [Cómo llamar a una función](#llamar-a-una-funcion)
    * [Parámetros y argumentos](#parametros-y-argumentos)
